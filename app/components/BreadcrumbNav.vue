<template>
  ...
  >
    ...
    <div class="absolute inset-0 overflow-hidden">
      <div class="absolute top-10 left-10 w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 bg-[#01b4d5]/10 rounded-full blur-3xl" />
      <div class="absolute bottom-10 right-10 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-[#0056b3]/10 rounded-full blur-3xl" />
      <div class="absolute top-1/2 left-1/3 w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 bg-[#01b4d5]/5 rounded-full blur-3xl" />
    </div>
