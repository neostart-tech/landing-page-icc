      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-12 justify-items-center px-4">
        ...
        >
          ...
          <div class="p-4 sm:p-5 md:p-6">
            <h3 class="text-lg md:text-xl font-semibold mb-2">{{ $t(block.titleKey) }}</h3>
            <p class="text-sm md:text-base leading-relaxed text-gray-700">{{ block.text1 }}</p>
            <p class="text-xs sm:text-sm md:text-base leading-relaxed mt-3 md:mt-4 text-gray-600">{{ block.text2 }}</p>
          </div>
        </div>
      </div>
