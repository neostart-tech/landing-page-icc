        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div class="bg-[#F5F5F5] text-black rounded-2xl p-6">
            ...
            <h3 class="text-lg font-extrabold mb-3">
              {{ $t('features_page.vehicle_park.carte_grise.title') }}
            </h3>
          ...
          <div class="bg-[#F5F5F5] text-black rounded-2xl p-6">
            ...
            >
            <h3 class="text-lg font-extrabold mb-3">
              {{ $t('features_page.vehicle_park.assurance.title') }}
            </h3>
            <p class="text-sm leading-relaxed">
          ...
          <div class="bg-[#F5F5F5] text-black rounded-2xl p-6">
            ...
            >
            <h3 class="text-lg font-extrabold mb-3">
              {{ $t('features_page.vehicle_park.visite_technique.title') }}
            </h3>
            <p class="text-sm leading-relaxed">
          ...
          <div class="bg-[#F5F5F5] text-black rounded-2xl p-6">
            ...
            >
            <h3 class="text-lg font-extrabold mb-3">
              {{ $t('features_page.vehicle_park.tvm.title') }}
            </h3>
            <p class="text-sm leading-relaxed">
        ...
        <div>
          ...
          <ul class="space-y-4 text-black">
            <li>
              ...
              <p class="pl-5 mt-1 text-sm text-black">
                {{ $t('features_page.request_ride.request.description') }}
              </p>
            </li>
            ...
            <li>
              ...
              <p class="pl-5 mt-1 text-sm text-black">
                {{ $t('features_page.request_ride.driver_response.description') }}
              </p>
            </li>
            ...
            <li>
              ...
              <p class="pl-5 mt-1 text-sm text-black">
                {{ $t('features_page.request_ride.discuss_evaluate.description') }}
              </p>
            </li>
          </ul>
        </div>
      ...
      <div class="mx-auto px-8 lg:px-16 xl:px-24 2xl:px-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div class="flex justify-center items-start">
          <img
            ...
            class="w-full max-w-md h-auto object-cover rounded-2xl"
          >
        </div>
      </div>
    </section>
